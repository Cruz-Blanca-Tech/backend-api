...
from src.contexts.data_quality_triage.domain.strategies.generic_strategy import GenericStrategy
...
class DossierStrategyFactory:
    ...
    def get_strategy_for_documents(cls, document_codes: set) -> DossierValidationStrategy:
        from src.contexts.data_quality_triage.domain.strategies.inscription_strategy import InscriptionStrategy
