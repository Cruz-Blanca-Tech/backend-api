...
def get_create_beneficiary_use_case(repo: SqlBeneficiaryRepository = Depends(get_beneficiary_repository)) -> CreateBeneficiaryUseCase:
    return CreateBeneficiaryUseCase(repo)
