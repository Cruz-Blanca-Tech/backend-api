...
async def handle_dossier_approved_event(event: DossierApprovedEvent, session: AsyncSession) -> None:
...
async def handle_dossier_pdf_archived_event(event: DossierPdfArchivedEvent, session: AsyncSession) -> None:
