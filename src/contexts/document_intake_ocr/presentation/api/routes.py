...
from src.contexts.document_intake_ocr.presentation.api.routers.sync_extraction_router import router as sync_extraction_router
...
intake_app.include_router(sync_extraction_router)